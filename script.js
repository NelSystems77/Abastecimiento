...
// 2. TUS DATOS JSON COMPLETOS (Base de búsqueda)
const productsData = [
...
const masterListNames = [
    ...
    "CN PARACETAMOL 500 MG, TABLETA", "EC26", "TU UNGUENTO ANTIHEMORROIDAL", "TU BETAMETASONA ( COMO 17 VALERAT",
    ...
    "CN CLORPROMAZINA HIDROCLORURO ( E", "CN CODEINA FOSFATO HEMIHIDRATADA", "CN BUTILBROMURO DE HIOSCINA 10", "CN HIDROCLOROTIAZIDA 25 MG. TABLE",
